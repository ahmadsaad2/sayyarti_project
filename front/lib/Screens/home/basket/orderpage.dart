  ...
  final List<Map<String, dynamic>> allOrders = [
    {
      ...
      'status': 'Pending',
      'date': '2025-1-30',
      'customerName': 'ahmad saad ',
      'phoneNumber': '0595822120',
      'problemDetails': 'check engine light',
      'preferredTime': '9-10',
      'method': 'Pickup',
      'problemImageOrVideo': 'attached',
      'carLicense': 'attached',
      'garageName': 'fathi',
      'trackingSteps': [
        {
    ...
    },
    {
      ...
      'userId': 1,
      'serviceType': 'Towing',
      'requestDate': '2025-29-01T10:00:00Z',
      'vehicleMakeModel': 'Toyota',
      'vehicleType': 'Car',
      'licensePlate': '123-d',
      'vehicleCondition': 'Non-drivable',
      'currentLocationAddress': 'Nablus',
      'nearestLandmark': ' city center',
      'latitude': 32.2211,
      'longitude': 35.2544,
      'customerName': 'ahmad',
      'phoneNumber': '0595822120',
      'alternativeContact': '0595822120',
